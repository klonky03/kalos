...
<%@ include file="./fragments/header.jsp" %>
	...
	<%
	ArrayList<ProdottoBean> orecchini = categorie.get(7);%>
	
	<div class="banner-container">
    	<img src="${pageContext.request.contextPath}/images/banner-orecchini.jpg" alt="Banner" class="banner-image">
	</div>
	...
	<div id="main" class="clear">
		...
		<div class="itemtwo">
			...
			<li><a href="carrello?action=addC&id=<%=bean.getIdProdotto()%>&page=Orecchini.jsp"><button id="add-to-cart">Aggiungi al carrello</button></a></li>
		 </ul>
		</div>
		<%
				}
